    ...
    <div class="container thank-you-container">
        <div class="card mx-auto" style="width: 50%;">
            <div class="card-body">
                ...
                <p>Your Registreation is Under review you will be notufied. you status : <%= ((Voter) session.getAttribute("voter")).getStatus() %></p>
    ...
    <script>
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (countdownNumber <= 0) {
                ...
                window.location.href = "voterLogin.jsp"; // Redirect to home.jsp after countdown
            }
